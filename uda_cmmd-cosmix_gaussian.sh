...
#SBATCH --mem=120000M      
#SBATCH --time=02-18:00   # DD-HH:MM:SS
...
pip install nuscenes_devkit-1.1.9-py3-none-any.whl
...
python adapt_cosmix.py --config_file configs/adaptation/nuscenes2semantickitti_cmmdcosmix_gaussian.yaml --method cmmd-cosmix
