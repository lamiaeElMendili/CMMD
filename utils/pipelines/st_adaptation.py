...
class Adaptation(pl.core.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        with torch.no_grad():
            ...
            target_pseudo = self.teacher_model(target_stensor).F
        ...
        s_out = self.student_model(source_stensor)
        t_out = self.student_model(mixed_tensor)
