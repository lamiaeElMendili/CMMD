...
class SemanticKITTIDataset(BaseDataset):
    def __init__(self,
        ...
        if return_inverse:
            self.class_inv_remap = self.maps['learning_map_inv']
    ...
    def __getitem__(self, i: int):
        ...
        if self.return_inverse :
            quantized_coords, feats, labels, voxel_idx, reverse_indices = ME.utils.sparse_quantize(points,
                                                                        colors,
                                                                        labels=labels,
        ...
        if self.return_inverse :
            reverse_indices = torch.from_numpy(reverse_indices)
