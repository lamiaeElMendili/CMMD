...
python adapt_cosmix.py --config_file configs/adaptation/synlidar2semantickitti/synlidar2semantickitti_st.yaml --method adabn
...
python adapt_cosmix.py --config_file configs/adaptation/nuscenes2semanticposs/nuscenes2semanticposs_st.yaml --method adabn
#python train_source.py --config_file configs/source/nuscenes2semanticposs.yaml
# to sync cosmix run 
# wandb sync /home/lamiaeel/projects/def-sdaniel/lamiaeel/CMMD/wandb/offline-run-20240405_113129-55l2yo7s -p 'SynLiDAR->SemanticKITTI'
